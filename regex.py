...
hand= """This file contains the actual data for your assignment - good luck!


Why should you learn to write programs?

Writing programs (or programming) is a very creative 
2431 and rewarding activity.  You can write programs for 
many reasons, ranging from making your living to solving
a difficult data analysis problem to having fun to helping
someone else solve a problem.  This book assumes that 
1252 everyone needs to know how to program, and that once 2949
4726 you know how to program you will figure out what you want 3210
to do with your newfound skills.  
2138 
1503 We are surrounded in our daily lives with computers ranging 
...
6662 speak to explain to the computer what we would like it to 
...
4930 from a piece of paper is hard for a computer to do 
but counting the words and telling you how many times
4016 the most used word was used is very easy for the
computer:

Our personal information analysis assistant quickly 
8107 told us that the word to was used sixteen times in the 9206
...
3720 Building useful, elegant, and clever programs for others to use is a very 5342
...
581 If we think of programs as the creative output of groups of programmers, 8606
...
5791 speak to give instructions to computers to 
develop software, we need to learn a small amount about 
how computers are built.  
3312 
3212 Central Processing Unit (or CPU) is 
the part of the computer that is built to be obsessed 
9191 with what is next?  If your computer is rated 4002
...
9849 5675 1247
2794 Secondary Memory is also used to store
...
3475 In the rest of this book, we will try to turn you into a person 9036
...
5956 problem you are trying to solve is the idea. 8829
...
simple 4896 programs, 8948 and 71 then we write increasingly complex programs over time.
...
as 2962 you 6129 write 7782 programs you will make up your own words that have meaning to 
...
what 8835 most 2110 dogs 8747 likely hear is,
...
2152 but for now we will focus on the Python equivalent of speak (in 
...
3687 you.  All you have to know is how to speak the Python language.
...
8466 programmers with Python acting as an intermediary.  Python 2290
...
programmer, 3101 parses 7624 the 9298 source code, and interprets the instructions on the fly.
 9618 Python is an interpreter and when we are running Python interactively, 
...
convention, 7791 Python 2948 scripts 2782 have names that end with .py.
...
3211 You will notice that there was no need to have quit() at the end of 2655
